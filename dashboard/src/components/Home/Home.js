      ...
      >
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div
            ...
            md:items-center space-y-4 md:space-y-0 md:space-x-6 md:bg-transparent 
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {Object.entries(selectedMachine.specs).map(
                      ([key, value]) => (
                        ...
                        >
                          <strong className="block text-sm uppercase mb-1">
                            {key}:
                          </strong>
                          <span>{value}</span>
                        </div>
            ...
            {[
              {
                ...
                desc: "Advanced manufacturing systems",
              },
              {
                Icon: Layers,
                title: "Integrated Solutions",
                desc: "Seamless industry connectivity",
              },
              {
                Icon: Globe,
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-3 gap-3">
          ...
          <div className="flex justify-center space-x-6">
            {[
              {
                Icon: Facebook,
                href: companyInfo.socialMedia.google,
